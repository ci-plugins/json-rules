...
import io.appform.jsonrules.expressions.preoperation.string.SubstringBeforeOperation;
...
public class SubStringBeforeOperationTest {
    ...
    public void testPositiveCases() throws Exception {
        Assert.assertTrue(EqualsExpression.builder()
                .path("$.abcd")
                .preoperation(SubstringBeforeOperation.builder().build())
                .value("$.abcd")
        ...
        Assert.assertTrue(NotEqualsExpression.builder()
                .path("$.abcd")
                .preoperation(SubstringBeforeOperation.builder().delimiter("o").build())
                .value("$.abcd")
                .extractValueFromPath(true)
                .build()
                .evaluate(context));
        Assert.assertTrue(StartsWithExpression.builder()
                ...
                .value("Hello world")
                .defaultResult(false)
                .valueCompareToPath(true)
                .build()
                .evaluate(context));
        Assert.assertTrue(NotInExpression.builder()
                .path("$.abcd")
                .preoperation(SubstringBeforeOperation.builder().delimiter("H").build())
                .values(Sets.newHashSet("a","e","i","o","u"))
                .build()
                .evaluate(context));
        Assert.assertTrue(EmptyExpression.builder()
                .path("$.stringifiedValue")
                .preoperation(SubstringBeforeOperation.builder().delimiter("9886098860").build())
                .defaultResult(false)
                .build()
                .evaluate(context));
        Assert.assertTrue(NotEmptyExpression.builder()
                .path("$.stringifiedValue")
                .preoperation(SubstringBeforeOperation.builder().delimiter("8").build())
                .build()
                .evaluate(context));
    }
    ...
    public void testNegativeCases() throws Exception {
        try {
            ...
            EqualsExpression.builder()
                .path("$.array_values")
                .preoperation(SubstringBeforeOperation.builder().delimiter("Hell").build())
                .value(20)
                .build()
                .evaluate(context);
        ...
        try {
            ...
            EqualsExpression.builder()
                .path("$.abcd")
                .preoperation(SubstringBeforeOperation.builder().delimiter("Hello2").build())
                .value("Hello")
                .build()
                .evaluate(context);
        } catch(IllegalArgumentException e) {
        ...
        try {
            ...
            EqualsExpression.builder()
                    .path("$.abcd")
                    .preoperation(SubstringBeforeOperation.builder().delimiter("").build())
                    .value("Hello")
                    .build()
                    .evaluate(context);
        } catch(IllegalArgumentException e) {
    ...
    public void testRepresentation() throws Exception {
        ...
        Assert.assertEquals("{\"type\":\"not\",\"children\":[{\"type\":\"or\",\"children\":[{\"type\":\"equals\",\"path\":\"$.value\",\"preoperation\":{\"operation\":\"sub_str_before\",\"suppressExceptions\":false},\"defaultResult\":false,\"value\":\"$.value\",\"extractValueFromPath\":true},{\"type\":\"not_equals\",\"path\":\"$.value\",\"preoperation\":{\"operation\":\"sub_str_before\",\"delimiter\":\"H\",\"suppressExceptions\":false},\"defaultResult\":true,\"value\":\"$.value\",\"extractValueFromPath\":true}]}]}", ruleRep);
    }
